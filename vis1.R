df1 = read.csv(file = '/Users/hadyelhossary/Downloads/DataViz_Project/cleaned2.csv')
...
pl + geom_bar(aes(fill=genres),stat = "identity")

# Interactive Bar-plot
p2 = pl + geom_bar(aes(fill=genres),stat = "identity")
ggplotly(p2)
